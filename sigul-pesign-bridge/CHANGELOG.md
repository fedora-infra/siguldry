...
- Logging the setfacl feature was raised from DEBUG to INFO level, and on success the command run is
  logged (#180)
...
- Logs no longer include their own timestamp as systemd records the time (#143)
